export default function Splash() {
  return (
    <div id="splash-screen"
      className="transition-opacity duration-500 ease-out overflow-hidden fixed inset-0 bg-base-200 flex flex-col items-center justify-center z-50">
      ...
      <div id="splash-title-container" className="relative h-[80px] flex items-center text-base-content/80 justify-center">
        <h1 id="splash-title" className="flex relative z-10 text-5xl font-bold">
      ...
      <p id="splash-tagline" data-lang-key="tagline" className="text-lg text-base-content/50 mt-2 opacity-0">Your Journey to a
        Healthier You.</p>
    </div>
  )
}
