        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-sm">
          ...
          <form onSubmit={authTry} id="auth-form">
            ...
            <div className="text-right mb-6">
              <a id="forgot-password-link" className="text-sm link link-hover link-primary" href="#"
          ...
          <p className="text-center text-sm text-gray-600 mt-4">
            ...
            <a id="auth-toggle-link" className="link link-hover link-primary" href="#" data-lang-key="authToggleAction">Sign
              Up</a>
          </p>
          ...
          <button ref={googleSignInBtnRef} id="google-signin-btn" className="w-full flex items-center justify-center btn btn-outline mt-4">
            ...
            <span data-lang-key="googleSignIn" onClick={signInWithGoogle}>Sign in with Google</span>
          </button>
